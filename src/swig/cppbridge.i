...
%feature("notabstract") PeriodicMDN;
...
//%{
//#include "../cpp/optimization/mdntrainer.h"
//%}
...
%template(FastMDNTrainer) MDNTrainer<MDN>;
%template(FastPeriodicMDNTrainer) MDNTrainer<PeriodicMDN>;
